...
<form class="layui-form">
    <div class="container">
        ...
        <fieldset class="layui-elem-field layui-field-title"
            ...
            <legend>蓝桥雇员管理系统用户登录</legend>
        </fieldset>

    <%= session.getAttribute(user.get)%>
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn" id="login" lay-filter="btnSubmit" lay-submit>登陆</button>
            </div>
        </div>
        <div class="layui-input-block">
            <a href="regist.jsp">没有账号？前往注册</a>
        </div>
